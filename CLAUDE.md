...
See the **developing-insta-cli** skill (`.claude/skills/developing-insta-cli/`) for the dev loop,
`src/` architecture, the PR-merge/approval flow, the release process (binaries + npm OIDC), and
gotchas.
